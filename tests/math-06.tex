...
\def\RegistOprBin#1Form#2Eval#3OccA#4OccB#5{%
  ...
  \xpndaft\def\csname #1@YopX@Np@YopY@Np\endcsname##1##2{\cfbox{#3{\cache}{##1}{##2}}}
  \xpndaft\def\csname #1@YopX@Np@YopY@Yp\endcsname##1##2p{\cfbox{\prs{#3{\cache}{##1}{##2}}}}
...
\RegistOprBin{catExp}Form{\catHomForm}Eval{\OprBinEvlInS}OccA{\occ}OccB{\occ}
...
\codeinline{$\catExp[\cat D]$} &
$\catExp[\cat D]$ 
\\
\codeinline{$\catExp[\cat D]<{x_u}$} &
$\catExp[\cat D]<{x_u}$ 
\\
\codeinline{$\catExp[\cat D]<{x_u}<{y_u}$} &
$\catExp[\cat D]<{x_u}<{y_u}$ 
\\
\codeinline{$\catExp[\cat D]<{x_u}<{y_u}p$} &
$\catExp[\cat D]<{x_u}<{y_u}p$ 
\\
\codeinline{$\catExp[\cat D]<{x_u}p$} &
$\catExp[\cat D]<{x_u}p$
\\
\codeinline{$\catExp[\cat D]<{x_u}p<{y_u}$} &
$\catExp[\cat D]<{x_u}p<{y_u}$
\\
\codeinline{$\catExp[\cat D]<{x_u}p<{y_u}p$} &
$\catExp[\cat D]<{x_u}p<{y_u}p$
\\
\codeinline{$\catExp[\cat D]<<{y_u}$} &
$\catExp[\cat D]<<{y_u}$ 
\\
\codeinline{$\catExp[\cat D]<<{y_u}<{x_u}$} &
$\catExp[\cat D]<<{y_u}<{x_u}$ 
\\
\codeinline{$\catExp[\cat D]<<{y_u}<{x_u}p$} &
$\catExp[\cat D]<<{y_u}<{x_u}p$ 
\\
\codeinline{$\catExp[\cat D]<<{y_u}p$} &
$\catExp[\cat D]<<{y_u}p$ 
\\
\codeinline{$\catExp[\cat D]<<{y_u}p<{x_u}$} &
$\catExp[\cat D]<<{y_u}p<{x_u}$ 
\\
\codeinline{$\catExp[\cat D]<<{y_u}p<{x_u}p$} &
