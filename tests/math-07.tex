...
$\evHomo[\catC]$ , \\
$\evHomo[\catC].{\objcn1}.{\objcn2}$ , $\evHomo[\catC].{\objcn1}.{\objcn2}p$   \\
$\evHomo[\catC]<{\objcn1}.{\objcn2}$ , $\evHomo[\catC]<{\objcn1}.{\objcn2}p$   \\
$\evHomo[\catC]<{\objcn1}p$ ,                                                  \\
$\evHomo[\catC]<{\objcn1}p.{\objcn2}$ , $\evHomo[\catC]<{\objcn1}p.{\objcn2}p$ \\
$\evHomo[\catC]>{\objcn2}.{\objcn1}$ , $\evHomo[\catC]>{\objcn2}.{\objcn1}p$   \\
$\evHomo[\catC]>{\objcn2}p$ ,                                                  \\
$\evHomo[\catC]>{\objcn2}p.{\objcn1}$ , $\evHomo[\catC]>{\objcn2}p.{\objcn1}p$ \\

$\evExpo[\catC]$ , \\
$\evExpo[\catC].{\objcn1}.{\objcn2}$ , $\evExpo[\catC].{\objcn1}.{\objcn2}p$   \\
$\evExpo[\catC]<{\objcn1}.{\objcn2}$ , $\evExpo[\catC]<{\objcn1}.{\objcn2}p$   \\
$\evExpo[\catC]<{\objcn1}p$ ,                                                  \\
$\evExpo[\catC]<{\objcn1}p.{\objcn2}$ , $\evExpo[\catC]<{\objcn1}p.{\objcn2}p$ \\
$\evExpo[\catC]>{\objcn2}.{\objcn1}$ , $\evExpo[\catC]>{\objcn2}.{\objcn1}p$   \\
$\evExpo[\catC]>{\objcn2}p$ ,                                                  \\
$\evExpo[\catC]>{\objcn2}p.{\objcn1}$ , $\evExpo[\catC]>{\objcn2}p.{\objcn1}p$ 
...
\tcblst{$\evHomo[\catC]$}                      &
$\evHomo[\catC]$                                  \\
\tcblst{$\evHomo[\catC].{\objcn1}.{\objcn2}$}  &
$\evHomo[\catC].{\objcn1}.{\objcn2}$              \\
\tcblst{$\evHomo[\catC].{\objcn1}.{\objcn2}p$} &
$\evHomo[\catC].{\objcn1}.{\objcn2}p$             \\
\tcblst{$\evHomo[\catC]<{\objcn1}.{\objcn2}$}  &
$\evHomo[\catC]<{\objcn1}.{\objcn2}$              \\
\tcblst{$\evHomo[\catC]<{\objcn1}.{\objcn2}p$} &
$\evHomo[\catC]<{\objcn1}.{\objcn2}p$             \\
\tcblst{$\evHomo[\catC]<{\objcn1}p$}           &
$\evHomo[\catC]<{\objcn1}p$                       \\
\tcblst{$\evHomo[\catC]<{\objcn1}p.{\objcn2}$} &
$\evHomo[\catC]<{\objcn1}p.{\objcn2}$             \\
\tcblst{$\evHomo[\catC]<{\objcn1}p.{\objcn2}p$}&
$\evHomo[\catC]<{\objcn1}p.{\objcn2}p$            \\
\tcblst{$\evHomo[\catC]>{\objcn2}.{\objcn1}$} &
$\evHomo[\catC]>{\objcn2}.{\objcn1}$              \\
\tcblst{$\evHomo[\catC]>{\objcn2}.{\objcn1}p$}&
$\evHomo[\catC]>{\objcn2}.{\objcn1}p$             \\
\tcblst{$\evHomo[\catC]>{\objcn2}p$}          &
$\evHomo[\catC]>{\objcn2}p$                       \\
\tcblst{$\evHomo[\catC]>{\objcn2}p.{\objcn1}$}&
$\evHomo[\catC]>{\objcn2}p.{\objcn1}$             \\
\tcblst{$\evHomo[\catC]>{\objcn2}p.{\objcn1}p$}&
$\evHomo[\catC]>{\objcn2}p.{\objcn1}p$            \\
\end{tblr}
...
\tcblst{$\evExpo$}                             &
$\evExpo[\catC]$                                  \\
\tcblst{$\evExpo[\catC].{\objcn1}.{\objcn2}$}  &
$\evExpo[\catC].{\objcn1}.{\objcn2}$              \\
\tcblst{$\evExpo[\catC].{\objcn1}.{\objcn2}p$} &
$\evExpo[\catC].{\objcn1}.{\objcn2}p$             \\
\tcblst{$\evExpo[\catC]<{\objcn1}.{\objcn2}$}  &
$\evExpo[\catC]<{\objcn1}.{\objcn2}$              \\
\tcblst{$\evExpo[\catC]<{\objcn1}.{\objcn2}p$} &
$\evExpo[\catC]<{\objcn1}.{\objcn2}p$             \\
\tcblst{$\evExpo[\catC]<{\objcn1}p$}           &
$\evExpo[\catC]<{\objcn1}p$                       \\
\tcblst{$\evExpo[\catC]<{\objcn1}p.{\objcn2}$} &
$\evExpo[\catC]<{\objcn1}p.{\objcn2}$             \\
\tcblst{$\evExpo[\catC]<{\objcn1}p.{\objcn2}p$}&
$\evExpo[\catC]<{\objcn1}p.{\objcn2}p$            \\
\tcblst{$\evExpo[\catC]>{\objcn2}.{\objcn1}$}  &
$\evExpo[\catC]>{\objcn2}.{\objcn1}$              \\
\tcblst{$\evExpo[\catC]>{\objcn2}.{\objcn1}p$} &
$\evExpo[\catC]>{\objcn2}.{\objcn1}p$             \\
\tcblst{$\evExpo[\catC]>{\objcn2}p$}           &
$\evExpo[\catC]>{\objcn2}p$                       \\
\tcblst{$\evExpo[\catC]>{\objcn2}p.{\objcn1}$} &
$\evExpo[\catC]>{\objcn2}p.{\objcn1}$             \\
\tcblst{$\evExpo[\catC]>{\objcn2}p.{\objcn1}p$}&
$\evExpo[\catC]>{\objcn2}p.{\objcn1}p$            \\
\end{tblr}
