...
% ----- 注册常用变量
\RegistVarFreqType{obj}Name{c}ppp
\RegistVarFreqType{obj}Name{init}Disp{0}ppp
\RegistVarFreqType{obj}Name{term}Disp{1}ppp
\RegistVarFreqType{arr}Name{f}ppp
\RegistVarFreqType{cat}Name{C}ppp
\RegistVarFreqType{cat}Name{D}ppp
\RegistVarFreqType{cat}Name{I}ppp
\RegistVarFreqType{fct}Name{F}ppp
\RegistVarFreqType{fct}Name{G}ppp
\RegistVarFreqType{ntf}Name{eta}Disp{\eta}ppp
% ----- 注册常量
