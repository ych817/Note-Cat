...
\def\RegistOpr@TypeA@opt#1[#2]{
  \xpndaft\def\csname opr#1defaultType\endcsname{}
  \xpndaft\def\csname opr#1display\endcsname{}
  \pgfkeys{
  ...
  \xpndaft\ncm\xpndaft{\csname #1\endcsname}[1][\csname opr#1defaultType\endcsname]{%
    \plr{\ensuremath{%
...
\def\RegistOpr@TypeC@opt#1[#2]{
  \xpndaft\def\csname opr#1defaultType\endcsname{}
  \xpndaft\def\csname opr#1defaultIndx\endcsname{}
  \xpndaft\def\csname opr#1display\endcsname{}
  \pgfkeys{
  ...
  \xpndaft\NewDocumentCommand\csname #1\endcsname{ 
    O{\csname opr#1defaultType\endcsname}   
    D<>{\csname opr#1defaultIndx\endcsname} 
  }{\plr{\ensuremath{%
    \stackunder[0pt]{\stackon[0pt]{\plr{\csname opr#1display\endcsname}}
    {}}
